...
class Application(tk.Frame):
    ...
    def login(self):
        ...
        # print(y_or_n)
            if y_or_n == "yes":
                ...
                # print(ch)
                # print(cw)
                self.photo_tk = ImageTk.PhotoImage(self.photo_pil.resize((ch, cw), Image.ANTIALIAS))
                # print(ch)
                # print(file1)
    ...
    def changeSize(self, event):
        ...
        self.photo_tk = ImageTk.PhotoImage(self.photo_pil.resize((nw, nh), Image.ANTIALIAS))
        self.t_label["image"] = self.photo_tk
        # self.t_label.image = self.photo_tk
