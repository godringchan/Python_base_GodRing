...
class Application(tk.Frame):
    ...
    def creatCheckButton(self):
        ...
        self.c1 = tk.Checkbutton(new_win, text="正面刚", variable=self.upside,
                                 onvalue=1, offvalue=0)
        self.c2 = tk.Checkbutton(new_win, text="后入式", variable=self.blackside, 
                                 onvalue=1, offvalue=0)
        self.c3 = tk.Checkbutton(new_win, text="69式", variable=self._69side,
                                 onvalue=1, offvalue=0)
        self.c4 = tk.Checkbutton(new_win, text="骑马式", variable=self.rideside,
                                 onvalue=1, offvalue=0)
        self.c1.pack(side="left")
        self.c2.pack(side="left")
        self.c3.pack(side="left")
        self.c4.pack(side="left")
        tk.Button(new_win, text="要用什么姿势", command=fack_xiaoyu).pack(side="left")
    ...
    def creatRadioButton(self):
        ...
        self.v = tk.StringVar()
        self.v.set("干")
        self._radiobutton_1 = tk.Radiobutton(new_win, text="干",
                                             value="干", variable=self.v)
        self._radiobutton_2 = tk.Radiobutton(new_win, text="不干",
                                             value="不干", variable=self.v)
    ...
    def print_bg_photo(self):
        pil_photo = Image.open(r"E:\个人资料文件\秘密花园\甜菜玉\图\mmexport1564498974832.jpg")
