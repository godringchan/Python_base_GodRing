...
click_button_text = {"小玉": xiaoyu_pic, "Angela小热巴": "小热巴图", "杨晨晨": "杨晨晨",
                     "Carry陈良玲": "Carry陈良玲", "筱慧": "筱慧"}
...
def click_button(button_text):
    ...
    # print(type(photo))
    tp = tk.Toplevel()
    tp_label = tk.Label(tp, image=photo)
    tp_label.pack()


for button_text in btns_text:
    button1 = tk.Button(buttons_frame, text=button_text, command=lambda button_text=button_text: click_button(button_text))
...
for i in range(13):
    tk.Label(keys_frame, width="5", height="10", bg="black" if i%2==0 else "white").pack(side="left", padx="1")
